...
class Annotation(models.Model):
    ...
    page = models.ForeignKey(Page, on_delete=models.CASCADE, related_name="annotatedPage", db_index=True)
    
    # restituisce l'annotazione come json */
    def asDict(self):
        return {
    ...
    # aggiorna l'annotazione con i campi di data */
